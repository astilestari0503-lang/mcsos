...
int  mcs_lockdep_before_acquire(mcs_lockdep_state_t *st, uint32_t class_id, const char *name);
int  mcs_lockdep_after_release(mcs_lockdep_state_t *st, uint32_t class_id, const char *name);
